...
# INSERT INTO `bloodpressure`.`user` (`birth_date`, `email`, `first_name`, `height`, `is_male`, `last_name`, `password`, `weight`, `username`) VALUES ('1992-12-25', 'user@gmail.com', 'User', 183, 1, 'User', 'Password1234!', 100, 'user');
